...
Благодаря интерфейсу командной строки, сериализации, данное дерево может быть использовано в других проектах.
В экосистеме CompPrehension данный проект главным образом используется для поддержки нескольких языков программирования
