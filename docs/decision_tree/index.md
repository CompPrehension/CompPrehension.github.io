---
title: Модель деревьев мыслительных процессов
---

Данный раздел описывает функционал и код проекта, представляющий модель *Thought Process Graph (граф мыслительных процессов)*, ранее известную как **Decision Tree (DT)** или **Thought Process Tree** (в других источниках Compprehensive ITS), созданную для организации автоматизированного обучения с помощью моделей мышления учащихся.

Разработка включает в себя несколько компонентов:

- [its_DomainModel](https://github.com/CompPrehension/its_DomainModel) - создание, валидация и преобразование моделей данных (модели данных о конкретных задачах, а также модели деревьев решений, решающих эти задачи).
- [its_Reasoner](https://github.com/CompPrehension/its_Reasoner) - вычисления (reasoning) на основе деревьев решений.
- [its_QuestionGen](https://github.com/CompPrehension/its_QuestionGen) - создание наводящих вопросов на основе деревьев решений, текстовое взаимодействие с пользователем.

**Проекты были созданы благодаря:** [Max-Person](https://github.com/Max-Person) (сейчас не работает над проектом)

Данные компоненты задуманы для использования в качестве **библиотек** в других проектах, написанных на Java или Kotlin (подробнее про языки [ниже](#java-и-kotlin)), т.е. сами не несут исполняемого кода как такового.
...
> [!warning] Содержание документации
> Содержание разделов данной вики, касающиеся библиотек its_DomainModel и its_Reasoner, адаптировано под версию 3.0.0 и новее. Версии 2.х разрабатывались оригинальным автором и отдельно не обновляются. Документация от него для этих версий находится [в отдельной вики](https://max-person.github.io/Compprehensive_ITS_wiki/), которая также не обновляется
...
От автора проекта:
> Я рекомендую использовать Maven + [JitPack](https://jitpack.io/)  для подключения проектов its_\* как зависимостей в ваших собственных проектах
