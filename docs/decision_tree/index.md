...
**Проекты были созданы благодаря:** [Max-Person](https://github.com/Max-Person) (сейчас не работает над проектом), документация от автора опубликована [здесь](https://max-person.github.io/Compprehensive_ITS_wiki/) (не обновляется, может быть не актуальна)
