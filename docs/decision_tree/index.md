...
Данный раздел описывает функционал и код проекта под рабочим названием **Decision Tree (DT)** или **Thought Process Tree** (в других источниках Compprehensive ITS), созданных для организации автоматизированного обучения с помощью моделей мышления учащихся.
